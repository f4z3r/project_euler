...
class TestSolutions(unittest.TestCase):
    ...
    def test_010_sum_primes(self):
        import solutions.p010_sum_primes
        self.assertEqual(17, solutions.p010_sum_primes.run(10))

    def test_011_largest_prod_grid(self):
        import solutions.p011_largest_prod_grid
        grid = [
